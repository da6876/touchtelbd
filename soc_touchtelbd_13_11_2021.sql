...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 13, 2021 at 09:38 AM
...
CREATE TABLE `product_order` (
  ...
  `product_id` int(11) NOT NULL,
  `product_brcode` varchar(500) DEFAULT 'N',
  `customer_info_id` int(11) NOT NULL,
  `qty` int(100) NOT NULL,
  `sell_price` int(100) NOT NULL,
  `other_price` int(100) NOT NULL DEFAULT 0,
  `vat_amount` int(100) NOT NULL DEFAULT 0,
  `create_by` varchar(50) DEFAULT 'N',
  `update_by` varchar(50) DEFAULT 'N',
...
INSERT INTO `product_order` (`product_order_id`, `invoice_no`, `product_id`, `product_brcode`, `customer_info_id`, `qty`, `sell_price`, `other_price`, `vat_amount`, `create_by`, `update_by`, `create_Date`, `update_date`) VALUES
(1, 'CCE5FSE', 11220013, 'BB88', 11660000, 1, 21000, 0, 0, '11220000', 'N', '2021/11/08', 'N'),
(2, 'FCLT3OK', 11220002, 'AA11', 11660006, 1, 21000, 0, 0, '11220000', 'N', '2021/11/10', 'N'),
(3, 'FCLT3OK', 11220013, 'BB99', 11660006, 1, 21000, 0, 0, '11220000', 'N', '2021/11/10', 'N');
...
CREATE TABLE `product_order_invoice` (
  ...
  `recive_amount` int(50) NOT NULL,
  `grand_total` int(50) NOT NULL,
  `deu_amount` int(50) NOT NULL,
  `payment_type` varchar(50) DEFAULT 'N',
  `product_order_status` varchar(50) DEFAULT 'N',
  `create_by` varchar(50) DEFAULT 'N',
  `create_date` varchar(50) DEFAULT 'N',
  `update_by` varchar(50) DEFAULT 'N',
  `update_date` varchar(50) DEFAULT 'N'
...
INSERT INTO `product_order_invoice` (`product_order_invoice_id`, `invoice_no`, `discount_price`, `recive_amount`, `grand_total`, `deu_amount`, `payment_type`, `product_order_status`, `create_by`, `create_date`, `update_by`, `update_date`) VALUES
(1, 'CCE5FSE', 0, 21000, 21000, 0, 'Mobile payments', 'Paid', '11220000', '2021/11/08', 'N', 'N'),
(2, 'FCLT3OK', 0, 42000, 42000, 0, 'Cash', 'Paid', '11220000', '2021/11/10', 'N', 'N'),
(3, 'FCLT3OK', 0, 42000, 42000, 0, 'Cash', 'Paid', '11220000', '2021/11/10', 'N', 'N');
...
INSERT INTO `product_stock_dtl` (`product_stock_dtl_id`, `product_id`, `invice_no`, `color`, `unit_price`, `sell_price`, `product_brcode`, `product_imei`, `create_by`, `update_by`, `create_info`, `update_info`, `sell_status`) VALUES
(1, 11220002, 'ET27BPPVAOK73CUUEZ1E', 'Red', 20000, 21000, 'AA11', '112233', '11220000', 'N', '2021-11-08 12:20:24', '2021-11-08 12:20:24', 0),
(2, 11220002, 'ET27BPPVAOK73CUUEZ1E', 'White', 20000, 21000, 'AA22', '332211', '11220000', 'N', '2021-11-08 12:20:24', '2021-11-08 12:20:24', 1),
(3, 11220003, 'ET27BPPVAOK73CUUEZ1E', 'White', 22000, 23000, 'AA33', '88008800', '11220000', 'N', '2021-11-08 12:22:22', '2021-11-08 12:22:22', 1),
(4, 11220003, 'ET27BPPVAOK73CUUEZ1E', 'Gray', 22000, 23000, 'AA44', '11002200', '11220000', 'N', '2021-11-08 12:22:22', '2021-11-08 12:22:22', 1),
(5, 11220004, 'ET27BPPVAOK73CUUEZ1E', 'Red', 25000, 26500, 'AA55', '85230000', '11220000', 'N', '2021-11-08 12:27:29', '2021-11-08 12:27:29', 1),
(6, 11220004, 'ET27BPPVAOK73CUUEZ1E', 'Green', 25000, 26500, 'AA66', '75230000', '11220000', 'N', '2021-11-08 12:27:29', '2021-11-08 12:27:29', 1),
(7, 11220004, 'ET27BPPVAOK73CUUEZ1E', 'White', 25000, 26500, 'AA77', '45230000', '11220000', 'N', '2021-11-08 12:27:29', '2021-11-08 12:27:29', 1),
(8, 11220005, 'ET27BPPVAOK73CUUEZ1E', 'Red', 32000, 33500, 'AA88', '8800000', '11220000', 'N', '2021-11-08 12:29:43', '2021-11-08 12:29:43', 1),
(9, 11220005, 'ET27BPPVAOK73CUUEZ1E', 'White', 32000, 33500, 'AA99', '9900000', '11220000', 'N', '2021-11-08 12:29:43', '2021-11-08 12:29:43', 1),
(10, 11220005, 'ET27BPPVAOK73CUUEZ1E', 'Light Blue', 32000, 33500, 'AA01', '0100000', '11220000', 'N', '2021-11-08 12:29:43', '2021-11-08 12:29:43', 1),
(11, 11220005, 'ET27BPPVAOK73CUUEZ1E', 'Light Green', 32000, 33500, 'AA02', '0200000', '11220000', 'N', '2021-11-08 12:29:44', '2021-11-08 12:29:44', 1),
(12, 11220012, 'PJE6EPW7DD08BHRSFWFS', 'White', 24500, 25500, 'BB11', '048080808', '11220000', 'N', '2021-11-08 12:31:20', '2021-11-08 12:31:20', 1),
(13, 11220012, 'PJE6EPW7DD08BHRSFWFS', 'Gray', 24500, 25500, 'BB22', '058080808', '11220000', 'N', '2021-11-08 12:31:20', '2021-11-08 12:31:20', 1),
(14, 11220012, 'PJE6EPW7DD08BHRSFWFS', 'Pink', 25000, 26000, 'BB22', '038080808', '11220000', 'N', '2021-11-08 12:31:20', '2021-11-08 12:31:20', 1),
(15, 11220013, 'PJE6EPW7DD08BHRSFWFS', 'White', 20000, 21000, 'BB99', '70808999', '11220000', 'N', '2021-11-08 12:36:48', '2021-11-08 12:36:48', 0),
(16, 11220013, 'PJE6EPW7DD08BHRSFWFS', 'Light Gray', 20000, 21000, 'BB88', '80708999', '11220000', 'N', '2021-11-08 12:36:48', '2021-11-08 12:36:48', 0);
...
(1, 11220002, 11100011, 'ET27BPPVAOK73CUUEZ1E', 'New1', 2, 'Active', '11220000', 'N', '2021-11-08 12:20:24', '2021-11-08 12:20:24', '8HE226YE9JGOA1SG974S'),
(2, 11220003, 11100011, 'ET27BPPVAOK73CUUEZ1E', 'New2', 2, 'Active', '11220000', 'N', '2021-11-08 12:22:21', '2021-11-08 12:22:21', '8HE226YE9JGOA1SG974S'),
(3, 11220004, 11100011, 'ET27BPPVAOK73CUUEZ1E', 'New3', 3, 'Active', '11220000', 'N', '2021-11-08 12:27:29', '2021-11-08 12:27:29', '8HE226YE9JGOA1SG974S'),
(4, 11220005, 11100011, 'ET27BPPVAOK73CUUEZ1E', 'New4', 4, 'Active', '11220000', 'N', '2021-11-08 12:29:43', '2021-11-08 12:29:43', '8HE226YE9JGOA1SG974S'),
(5, 11220012, 11100011, 'PJE6EPW7DD08BHRSFWFS', 'New Item', 3, 'Active', '11220000', 'N', '2021-11-08 12:31:20', '2021-11-08 12:31:20', '8HE226YE9JGOA1SG974S'),
(6, 11220013, 11100011, 'PJE6EPW7DD08BHRSFWFS', 'AA', 2, 'Active', '11220000', 'N', '2021-11-08 12:36:47', '2021-11-08 12:36:47', '0KHCENDIABDSFUKKYVJZ');
...
--
ALTER TABLE `customer_info`
  MODIFY `customer_info_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11660008;
...
--
ALTER TABLE `product_order_invoice`
  MODIFY `product_order_invoice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `product_stock_dtl`
  MODIFY `product_stock_dtl_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `product_stock_mst`
--
ALTER TABLE `product_stock_mst`
  MODIFY `product_stock_mst_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

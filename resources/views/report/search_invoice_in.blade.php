                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="breadcrumb-holder">
                            <h1 class="main-title float-left">Invoice Info</h1>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-12 col-xl-12">
                        <div class="card mb-3">
                            <div class="card-header">
                                ...
                                <h3><i class="fa fa-table"></i> Search Invoice</h3>
                            </div>
                            ...
                            <div class="card-body">
                                    ...
                                    <form id="addNewCategories" action="#" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label>Enter The Invice No:</label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" onclick="SearchInvoice()" class="btn btn-primary">Search</button>
    ...
    $(document).ready(function () {
        ...
        $('#invoice_no').keyup(function () {
            ...
            if (query != '') {
                ...
                $.ajax({
                    url: "{{ route('autocomplete.searchInvoiceByNoIn') }}",
                    method: "POST",
